...
class Options(object):
    """docstring for GetDeutschVerb"""

    def __init__(self):
        super().__init__()
        self.verb_base_url = 'https://konjugator.reverso.net/konjugation-deutsch-verb-XXXXXX.html'
        self.verb_lists_needed = ['Indikativ Präsens', 'Indikativ Präteritum', 'Infinitiv Perfekt']
        self.seperator = '/'
...
class DeVerbs(Options):
    """docstring for DeVerbs"""

    def __init__(self):
        super(DeVerbs, self).__init__()
        self.base_url = 'https://konjugator.reverso.net/konjugation-deutsch-verb-XXXXXX.html'
        self.verb_lists_needed = ['Indikativ Präsens', 'Indikativ Präteritum', 'Infinitiv Perfekt']
        self.seperator = '/'
    ...
    def get_verb(self, response):
        ...
        blocks = soup.find_all(attrs={"mobile-title": self.verb_lists_needed})
    ...
    def get_verbform(self, block):
        try:
            Verbform = block.find(string=re.compile("er/sie/es")).parent.next_sibling.text.strip()
...
class Examples(Options):
    ...
    def __init__(self, language='en'):
        ...
        if language == 'fr':
            self.base_url = f"https://context.reverso.net/übersetzung/deutsch-franzosisch/XXXXXX"
        elif language == 'en':
            self.base_url = f"https://context.reverso.net/übersetzung/deutsch-englisch/XXXXXX"
    ...
    def get_examples(self, response):
        ...
        anki_name['english_translation'] = [english_tr.text.strip() for english_tr in english_trans]
